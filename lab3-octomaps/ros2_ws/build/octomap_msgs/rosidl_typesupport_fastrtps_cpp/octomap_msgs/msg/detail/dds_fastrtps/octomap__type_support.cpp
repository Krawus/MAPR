...
#include "octomap_msgs/msg/detail/octomap__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const octomap_msgs::msg::Octomap *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<octomap_msgs::msg::Octomap *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Octomap__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const octomap_msgs::msg::Octomap *>(
...
static size_t _Octomap__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Octomap(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Octomap__callbacks = {
  "octomap_msgs::msg",
  "Octomap",
...
static rosidl_message_type_support_t _Octomap__handle = {
...
{
  return &octomap_msgs::msg::typesupport_fastrtps_cpp::_Octomap__handle;
}
