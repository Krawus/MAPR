...
#include "octomap_msgs/msg/detail/octomap_with_pose__rosidl_typesupport_fastrtps_c.h"
...
using _OctomapWithPose__ros_msg_type = octomap_msgs__msg__OctomapWithPose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _OctomapWithPose__ros_msg_type * ros_message = static_cast<const _OctomapWithPose__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _OctomapWithPose__ros_msg_type * ros_message = static_cast<_OctomapWithPose__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _OctomapWithPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_octomap_msgs__msg__OctomapWithPose(
...
static size_t _OctomapWithPose__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_octomap_msgs__msg__OctomapWithPose(
...
static message_type_support_callbacks_t __callbacks_OctomapWithPose = {
  "octomap_msgs::msg",
  "OctomapWithPose",
...
static rosidl_message_type_support_t _OctomapWithPose__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_OctomapWithPose,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, octomap_msgs, msg, OctomapWithPose)() {
  return &_OctomapWithPose__type_support;
}
