...
#include "octomap_msgs/srv/detail/get_octomap__rosidl_typesupport_fastrtps_c.h"
...
using _GetOctomap_Request__ros_msg_type = octomap_msgs__srv__GetOctomap_Request;
...
size_t get_serialized_size_octomap_msgs__srv__GetOctomap_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetOctomap_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_octomap_msgs__srv__GetOctomap_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_octomap_msgs
size_t max_serialized_size_octomap_msgs__srv__GetOctomap_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GetOctomap_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_octomap_msgs__srv__GetOctomap_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, octomap_msgs, srv, GetOctomap_Request)() {
...
using _GetOctomap_Response__ros_msg_type = octomap_msgs__srv__GetOctomap_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_octomap_msgs
size_t get_serialized_size_octomap_msgs__srv__GetOctomap_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetOctomap_Response__ros_msg_type * ros_message = static_cast<const _GetOctomap_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_octomap_msgs__srv__GetOctomap_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_octomap_msgs
size_t max_serialized_size_octomap_msgs__srv__GetOctomap_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GetOctomap_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_octomap_msgs__srv__GetOctomap_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, octomap_msgs, srv, GetOctomap_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, octomap_msgs, srv, GetOctomap)() {
